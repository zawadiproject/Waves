  ...
  "check order execution" - {
    ...
    "make order and after matcher's restart try to cancel it" in {
      ...
      val aliceOrder = matcherNode
        .placeOrder(aliceAcc, aliceWavesPair, OrderType.SELL, 500, 2.waves * Order.PriceConstant, minMatcherFee, orderVersion)
      ...
      val aliceSecondOrder =
        matcherNode.placeOrder(aliceAcc, aliceWavesPair, OrderType.SELL, 500, 2.waves * Order.PriceConstant, minMatcherFee, orderVersion, 5.minutes)

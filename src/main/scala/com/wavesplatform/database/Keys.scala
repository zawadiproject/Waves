...
object Keys {
  ...
  def blockFeeHistory: Key[Seq[Int]]   = historyKey(44, Array())
  def blockFee(height: Int): Key[Long] = Key(h(45, height), Option(_).fold(0L)(Longs.fromByteArray), Longs.toByteArray)
}
